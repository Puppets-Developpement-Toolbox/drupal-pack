...
// $settings['vite']['devServerUrl'] = 'http://front.website-factory.lndo.site/themes/hospitality';
$settings['vite']['useDevServer'] = true;

$config['environment_indicator.indicator']['bg_color'] = '#0C7360';
$config['environment_indicator.indicator']['fg_color'] = '#B5D8C7';
